...
export const Route = createFileRoute("/internal/proofs/hood-terps")({
  component: InternalHoodTerpsPage,
});

function InternalHoodTerpsPage() {
  return (
    <CapabilityGate capability="internal.proofs.view">
      <ProofPage />
    </CapabilityGate>
  );
}
